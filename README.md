...
This project provides split IP blocklists for inbound traffic, updated hourly, with built-in exclusions for major public DNS resolvers to ensure uninterrupted access to essential services.
